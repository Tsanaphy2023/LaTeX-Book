...
\begin{enumerate}
    ...
    \item จงอธิบายความแตกต่างระหว่างพลังงานมืด (Dark Energy: $\Lambda$) และสสารมืด (Dark Matter) พร้อมทั้งระบุหลักฐานเชิงสังเกตการณ์ที่สนับสนุนการมีอยู่ของทั้งสององค์ประกอบในแบบจำลองมาตรฐานทางจักรวาลวิทยา $\Lambda\text{CDM}$
\end{enumerate}
