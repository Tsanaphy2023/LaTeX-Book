...
เมื่อศึกษาบทที่ 1 จบแล้ว นิสิตและผู้ศึกษาสามารถ:
\begin{enumerate}
    \item อธิบายข้อจำกัดของกลศาสตร์นิวตันและการทดลองของไมเคิลสัน-มอร์ลีย์ (Michelson-Morley Experiment) ได้อย่างถูกต้อง
    \item สรุปสัจพจน์ของไอน์สไตน์ทั้งสองประการ และพิสูจน์ที่มาของการแปลงแบบลอเรนซ์ (Lorentz Transformations)
    \item คำนวณปรากฏการณ์การยืดออกของเวลา (Time Dilation) และการหดสั้นของความยาว (Length Contraction)
    \item วิเคราะห์โครงสร้างปริภูมิ-เวลา 4 มิติ (Minkowski Spacetime) และกรวยแสง (Light Cone)
    \item คำนวณความสัมพันธ์ระหว่างโมเมนตัมสัมพัทธภาพและพลังงานรวม $E^2 = p^2 c^2 + m_0^2 c^4$
    \item ออกแบบและพัฒนาสคริปต์ Python เพื่อจำลองการแปลงพิกัดและการพล็อตกราฟตัวคูณลอเรนซ์ $\gamma(v)$
\end{enumerate}
...
\section{สัจพจน์ของไอน์สไตน์ (Einstein's Postulates)}
\index{สัจพจน์ของไอน์สไตน์}

ในปี ค.ศ. 1905 อัลเบิร์ต ไอน์สไตน์ ได้เสนอแนวคิดปฏิวัติวงการฟิสิกส์ โดยตั้งสมมติฐานมูลฐาน 2 ข้อ:

\begin{mathdefinition}[สัจพจน์สองประการของทฤษฎีสัมพัทธภาพพิเศษ]
\begin{enumerate}
    \item \textbf{หลักความสัมพัทธ์ (Principle of Relativity):} กฎเกณฑ์ทางฟิสิกส์ทั้งปวงย่อมมีรูปแบบทางคณิตศาสตร์เหมือนกันในทุกกรอบอ้างอิงเฉื่อย (Inertial Frames of Reference) ไม่มีกรอบอ้างอิงใดที่มีอภิสิทธิ์เหนือกรอบอื่น
    \item \textbf{ความคงที่ของอัตราเร็วแสง (Constancy of the Speed of Light):} อัตราเร็วของแสงในสุญญากาศ $c$ มีค่าคงที่สัมบูรณ์เท่ากันเสมอในทุกกรอบอ้างอิงเฉื่อย โดยไม่ขึ้นกับสถานะการเคลื่อนที่ของแหล่งกำเนิดแสงหรือผู้สังเกต
\end{enumerate}
\end{mathdefinition}

\section{การแปลงแบบลอเรนซ์ (Lorentz Transformations)}
\index{การแปลงแบบลอเรนซ์}
\index{ตัวคูณลอเรนซ์}

พิจารณากรอบอ้างอิงสองกรอบ $S$ และ $S'$ โดยที่ $S'$ เคลื่อนที่สัมพันธ์กับ $S$ ด้วยความเร็วคงที่ $v$ ในแนวแกน $+x$ โดยสมมติว่าจุดกำเนิด $O$ และ $O'$ ทับกันพอดีที่เวลา $t = t' = 0$ การแปลงพิกัดของกาลิเลโอดั้งเดิม ($x' = x - vt, t' = t$) ไม่สามารถรักษาความคงที่ของ $c$ ได้ ไอน์สไตน์จึงอนุมานการแปลงที่ถูกต้อง:
...
\section{ผลสืบเนื่องทางจลนศาสตร์: การยืดออกของเวลาและการหดสั้นของความยาว}
\index{การยืดออกของเวลา}
\index{การหดสั้นของความยาว}
\index{เวลาเฉพาะ}

\subsection{การยืดออกของเวลา (Time Dilation)}
พิจารณานาฬิกาแสงที่อยู่นิ่งในกรอบ $S'$ ช่วงเวลาที่นาฬิกาบันทึกได้ในกรอบที่ตัวเองอยู่นิ่งเรียกว่า \textbf{เวลาเฉพาะ (Proper Time, $\Delta t_0$)} เมื่อผู้สังเกตในกรอบ $S$ วัดช่วงเวลาของเหตุการณ์เดียวกัน จะพบว่าเวลาเดินช้าลงตามความสัมพันธ์:
\begin{equation}
\Delta t = \gamma \Delta t_0 = \frac{\Delta t_0}{\sqrt{1 - v^2/c^2}} \ge \Delta t_0
\end{equation}

\subsection{การหดสั้นของความยาว (Length Contraction)}
วัตถุที่มีความยาววัดได้ขณะอยู่นิ่งในกรอบของตัวเองเรียกว่า \textbf{ความยาวเฉพาะ (Proper Length, $L_0$)} เมื่อผู้สังเกตที่เคลื่อนที่สัมพันธ์กับวัตถุด้วยความเร็ว $v$ ในแนวขนานกับมิติของวัตถุวัดความยาว จะพบว่าความยาวหดสั้นลง:
\begin{equation}
...
\begin{itemize}
    ...
    \item การหดสั้นไม่ใช่การบีบอัดเชิงกลศาสตร์ของเนื้อสาร แต่เป็นผลจากธรรมชาติของปริภูมิ-เวลา (Spacetime) ที่สังเกตจากต่างกรอบอ้างอิง
\end{itemize}
\end{pitfallbox}

\section{ปริภูมิ-เวลา 4 มิติ และกรวยแสง (Minkowski Spacetime \& Light Cone)}
\index{มินคอฟสกี}
\index{กรวยแสง}
...
\begin{enumerate}
    \item $\Delta s^2 > 0$ : \textbf{เหมือนเวลา (Timelike)} เหตุการณ์ทั้งสองสามารถเชื่อมโยงกันด้วยความสัมพันธ์เชิงเหตุและผล (Causality) ได้
    \item $\Delta s^2 = 0$ : \textbf{เหมือนแสง (Lightlike หรือ Null)} เส้นทางของอนุภาคที่เคลื่อนที่ด้วยความเร็วแสง (เช่น โฟตอน)
    \item $\Delta s^2 < 0$ : \textbf{เหมือนปริภูมิ (Spacelike)} ไม่มีสัญญาณใดในเอกภพสามารถส่งหากันได้ทัน (ไม่มีความสัมพันธ์เชิงสาเหตุ)
\end{enumerate}
...
พลังงานรวมสัมพัทธภาพ (Total Relativistic Energy, $E$) ประกอบด้วย \textbf{พลังงานนิ่ง (Rest Energy, $E_0$)} และ \textbf{พลังงานจลน์สัมพัทธภาพ ($K$)}:
\begin{equation}
...
\begin{itemize}
    \item \textbf{Shader Pipeline:} GLSL Fragment Shader คำนวณไฮเปอร์โบลา $\Delta s^2 = \text{const}$ แบบเรียลไทม์
    \item \textbf{Tracking:} MediaPipe Hands ควบคุมการหมุนมุมมองและ Pinch Gesture เพื่อเร่งความเร็วของยาน
    \item \textbf{Performance Target:} $60\text{ FPS}$ บนเบราว์เซอร์มือถือ รองรับ WebXR API
\end{itemize}
\end{arbox}
...
\begin{equation}
d_{\text{classical}} = v \tau_0 = (0.995 \times 3.00 \times 10^8\text{ m/s}) \times (2.20 \times 10^{-6}\text{ s}) \approx 656.7\text{ m} \approx 0.66\text{ km}
\end{equation}
...
\begin{equation}
d_{\text{Earth}} = v \Delta t = (0.995 \times 3.00 \times 10^8\text{ m/s}) \times (22.03 \times 10^{-6}\text{ s}) \approx 6576\text{ m} \approx 6.58\text{ km}
\end{equation}
...
\begin{enumerate}
    \item โปรตอนถูกเร่งในเครื่องเร่งอนุภาคจนมีพลังงานจลน์เท่ากับ 3 เท่าของพลังงานนิ่งของมัน จงคำนวณ:
    \begin{enumerate}
