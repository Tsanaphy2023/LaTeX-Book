...
\begin{enumerate}
    \item สมบัติของนิวเคลียสและพลังงานยึดเหนี่ยว
    \item แบบจำลองหยดของเหลวและสูตรมวลไวซ์แซคเกอร์
    \item กัมมันตภาพรังสีและสมการลูกโซ่ของเบตแมน
    \item ปฏิกิริยานิวเคลียร์ฟิชชันและฟิวชัน
    \item สถาปัตยกรรมการจำลองเสมือนจริง AR/XR Nuclear Chain Reaction Simulator
    \item การคำนวณเชิงตัวเลขด้วย Python Bateman Decay Chain Solver
...
\begin{enumerate}
    \item อธิบายองค์ประกอบของนิวเคลียส คำนวณมวลบกพร่อง และพลังงานยึดเหนี่ยวนิวเคลียสได้อย่างถูกต้อง
    \item วิเคราะห์กราฟพลังงานยึดเหนี่ยวต่อนิวคลีออน ($B/A$) และอธิบายเสถียรภาพของนิวเคลียสได้อย่างแม่นยำ
    \item คำนวณมวลและพลังงานยึดเหนี่ยวด้วยสูตรมวลกึ่งเชิงประจักษ์ของไวซ์แซคเกอร์ได้อย่างเป็นระบบ
    \item จำแนกกลไกการสลายตัวของกัมมันตรังสีชนิดแอลฟา บีตา และแกมมาได้อย่างถูกต้อง
    \item แก้สมการการสลายตัวลูกโซ่กัมมันตรังสีของเบตแมนด้วยการวิเคราะห์เชิงตัวเลขใน Python ได้อย่างมีประสิทธิภาพ
    \item อธิบายเงื่อนไขวิกฤตของปฏิกิริยาลูกโซ่ฟิชชันและสภาวะฟิวชันตามเกณฑ์ของลอว์สันได้อย่างถูกต้อง
\end{enumerate}

\noindent\textbf{กิจกรรมการเรียนการสอน}
\begin{enumerate}
    \item การบรรยายเชิงทฤษฎีประกอบการอภิปรายเรื่องพลังงานยึดเหนี่ยวนิวเคลียสและแบบจำลองหยดของเหลว
    \item กิจกรรมกลุ่มย่อยวิเคราะห์ปฏิกิริยานิวเคลียร์ฟิชชันและฟิวชัน และเกณฑ์ความเสถียรของนิวเคลียส
    \item ปฏิบัติการจำลองสถานการณ์ปฏิกิริยาลูกโซ่นิวเคลียร์ Nuclear Chain Reaction Simulator ในระบบ WebXR
    \item ปฏิบัติการคอมพิวเตอร์เขียนโปรแกรม Python แก้สมการอนุพันธ์ลูกโซ่การสลายตัวของเบตแมน
    \item การศึกษาและแก้โจทย์ปัญหาฟิสิกส์นิวเคลียร์ตามระเบียบวิธี P-S-C-T
\end{enumerate}

\noindent\textbf{สื่อการเรียนการสอน}
\begin{enumerate}
    \item เอกสารคำสอน บทที่ 5 ฟิสิกส์นิวเคลียร์และปฏิกิริยานิวเคลียร์
    \item สื่อจำลอง 3 มิติปฏิสัมพันธ์ WebXR Nuclear Chain Reaction Simulator
    \item ชุดสคริปต์ภาษา Python (SciPy solve\_ivp) จำลองการสลายตัวของสารกัมมันตรังสีลูกโซ่
...
\begin{enumerate}
    ...
    \item การประเมินผลการทดลองจำลองสถานการณ์เสมือนจริงใน WebXR
...
\section{แบบจำลองหยดของเหลวและสูตรมวลไวซ์แซคเกอร์}
\index{SEMF}
\index{แบบจำลองหยดของเหลว}

\textbf{แบบจำลองหยดของเหลวและสูตรมวลไวซ์แซคเกอร์ (Semi-Empirical Mass Formula, SEMF)} เสนอโดย คาร์ล ฟรีดริช ฟอน ไวซ์แซคเกอร์ (Carl Friedrich von Weizsäcker) โดยมองนิวเคลียสเสมือนหยดของเหลวที่มีแรงตึงผิวและประจุไฟฟ้า
\begin{equation}
B(A, Z) = a_v A - a_s A^{2/3} - a_c \frac{Z(Z-1)}{A^{1/3}} - a_a \frac{(A - 2Z)^2}{A} + \delta(A, Z)
\end{equation}
โดยที่ค่าคงที่จากการทดลองโดยประมาณคือ
\begin{itemize}
    \item $a_v \approx 15.8\text{ MeV}$ (พจน์ปริมาตร)
    \item $a_s \approx 18.3\text{ MeV}$ (พจน์พื้นที่ผิว)
    \item $a_c \approx 0.714\text{ MeV}$ (พจน์แรงผลักคูลอมบ์)
    \item $a_a \approx 23.2\text{ MeV}$ (พจน์อสมมาตร)
    \item $\delta(A, Z)$ คือพจน์การจับคู่ (Pairing Term) มีค่าเป็น $+a_p A^{-1/2}$ สำหรับคู่-คู่, $0$ สำหรับคี่-คู่, และ $-a_p A^{-1/2}$ สำหรับคี่-คี่
\end{itemize}

\section{กัมมันตภาพรังสีและสมการลูกโซ่ของเบตแมน}
\index{กัมมันตภาพรังสี}
\index{สมการเบตแมน}
\index{ครึ่งชีวิต}

\textbf{กัมมันตภาพรังสีและสมการลูกโซ่ของเบตแมน (Bateman Equations)} กฎการสลายตัวของสารกัมมันตรังสีชนิดเดียวคือ
\begin{equation}
...
\subsection{นิวเคลียร์ฟิชชัน}
\textbf{นิวเคลียร์ฟิชชัน (Nuclear Fission)} เมื่อยูเรเนียม-235 จับนิวตรอนช้า (Thermal Neutron) จะเกิดการแตกตัวให้นิวเคลียสขนาดกลางและนิวตรอนความเร็วสูง 2--3 ตัว เช่น
\begin{equation}
...
\subsection{นิวเคลียร์ฟิวชัน}
\textbf{นิวเคลียร์ฟิวชัน (Nuclear Fusion)} ปฏิกิริยารวมตัวของนิวเคลียสเบา เช่น วงจรดิวเทอเรียม-ทริเทียม (D-T)
\begin{equation}
...
\begin{enumerate}
    ...
    \item ผู้เรียนสามารถเลื่อนแท่งควบคุมนิวตรอน (Control Rods) ที่ทำจากแคดเมียมหรือโบรอนเข้า-ออก เพื่อสังเกตค่าตัวคูณการคูณจำนวนนิวตรอนประสิทธิผล $k_{\text{eff}}$ ดังนี้
    \begin{itemize}
        \item $k_{\text{eff}} < 1$ หมายถึง สภาวะต่ำกว่าวิกฤต (Subcritical) ปฏิกิริยามอดดับลง
        \item $k_{\text{eff}} = 1$ หมายถึง สภาวะวิกฤต (Critical) เครื่องปฏิกรณ์เดินเครื่องด้วยกำลังคงที่
        \item $k_{\text{eff}} > 1$ หมายถึง สภาวะเหนือวิกฤต (Supercritical) ปฏิกิริยาทวีคูณอย่างรวดเร็ว
    \end{itemize}
\end{enumerate}
\end{arbox}
...
\section{ปัญญาประดิษฐ์และการเรียนรู้เชิงลึกในฟิสิกส์นิวเคลียร์และฟิวชัน}
\index{ปัญญาประดิษฐ์ในฟิสิกส์นิวเคลียร์}
\index{โทคาแมก}
\index{Deep Reinforcement Learning}

ในฟิสิกส์นิวเคลียร์ยุคใหม่ การสร้างแบบจำลองโครงสร้างนิวเคลียสของไอโซโทปที่ไม่เสถียร (Exotic Nuclei) ที่อยู่ห่างไกลจากแนวเสถียรภาพ (Drip Lines) เป็นความท้าทายอย่างยิ่ง โครงข่ายประสาทเทียมเชิงลึก (Deep Neural Networks) ถูกนำมาฝึกฝนกับฐานข้อมูลมวลนิวเคลียสจากการทดลอง เพื่อทำนาย \textbf{มวลพร่อง (Mass Excess)} และพลังงานยึดเหนี่ยวนิวเคลียส ซึ่งให้ความแม่นยำทางสถิติสูงกว่าสูตรกึ่งเชิงประจักษ์ของไวซ์แซกเกอร์อย่างมีนัยสำคัญ

นอกจากนี้ ในเทคโนโลยีพลังงานนิวเคลียร์ฟิวชัน เครื่องปฏิกรณ์แบบ \textbf{โทคาแมก (Tokamak)} จำเป็นต้องกักเก็บพลาสมาอุณหภูมิหลายสิบล้านองศาเซลเซียสไว้ด้วยสนามแม่เหล็กรูปวงแหวน (Toroidal Magnetic Field) ความไร้เสถียรภาพทางแม่เหล็กพลศาสตร์ (MHD Instabilities) เช่น โหมดการฉีกขาด (Tearing Modes) มักนำไปสู่ปรากฏการณ์พลาสมาแตกระเบิด (Plasma Disruption) ซึ่งสร้างความเสียหายต่อผนังเตาปฏิกรณ์

ปัจจุบัน สถาบันวิจัยชั้นนำของโลกได้นำ \textbf{การเรียนรู้แบบเสริมกำลังเชิงลึก (Deep Reinforcement Learning: DRL)} มาใช้ควบคุมขดลวดแม่เหล็กไฟฟ้านับสิบชุดแบบเรียลไทม์ (มิลลิวินาทีต่อมิลลิวินาที) เช่น งานวิจัยของ DeepMind ร่วมกับสถาบันวิจัยพลาสมา EPFL (Degrave et al., 2022) บนเครื่องโทคาแมก TCV ซึ่งพิสูจน์ให้เห็นว่า AI สามารถเรียนรู้วิธีปรับเปลี่ยนรูปร่างของพลาสมาและควบคุมเสถียรภาพได้อย่างอัตโนมัติ เปิดศักราชใหม่ของการผลิตพลังงานฟิวชันสะอาดสู่อนาคต
...
\begin{enumerate}
    ...
    \item จงอธิบายเกณฑ์ของลอว์สัน (เกณฑ์ของลอว์สัน $n \tau_E \ge 10^{20}\text{ m}^{-3}\text{s}$) สำหรับการจุดระเบิดพลาสมาฟิวชัน (Fusion Ignition) และเปรียบเทียบการกักขังพลาสมาด้วยสนามแม่เหล็ก (Magnetic Confinement -- Tokamak) กับการกักขังด้วยความเฉื่อย (Inertial Confinement -- Laser Fusion)
\end{enumerate}
