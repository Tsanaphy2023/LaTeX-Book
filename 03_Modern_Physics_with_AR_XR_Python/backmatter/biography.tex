...
\begin{minipage}[c]{0.28\textwidth}
    \centering
    \begin{tikzpicture}
        \fill[black!15] (0.05,-0.05) circle (1.45cm);
        \node[circle, draw=quantumGold, line width=2.5pt, inner sep=0pt] at (0,0) {
            \includegraphics[width=2.8cm,height=2.8cm,keepaspectratio]{images/author_chewa_circle_final.png}
        };
    \end{tikzpicture}
\end{minipage}\hfill
\begin{minipage}[c]{0.69\textwidth}
    {\fontsize{17}{22}\selectfont\bfseries\color{darkNavy} ผู้ช่วยศาสตราจารย์ ดร.ชีวะ ทัศนา}\\[0.2cm]
...
\vspace{0.4cm}
{\color{cyberBlue!30}\hrule height 1pt}
\vspace{0.4cm}

\noindent
\begin{minipage}[t]{0.48\textwidth}
    {\fontsize{13}{16}\selectfont\bfseries\color{cyberBlue} ประวัติการศึกษา}\par\vspace{4pt}
    ...
    \vspace{0.35cm}
    {\fontsize{13}{16}\selectfont\bfseries\color{cyberBlue} ภาระงานสอนประจำ}\par\vspace{4pt}
    \begin{itemize}\setlength{\itemsep}{2pt}\setlength{\parsep}{0pt}\setlength{\topsep}{2pt}\setlength{\partopsep}{0pt}\setlength{\leftmargin}{12pt}
...
\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}
    {\fontsize{13}{16}\selectfont\bfseries\color{neonPurple} ความเชี่ยวชาญและงานวิจัยที่สนใจ}\par\vspace{4pt}
    \begin{itemize}\setlength{\itemsep}{3pt}\setlength{\parsep}{0pt}\setlength{\topsep}{2pt}\setlength{\partopsep}{0pt}\setlength{\leftmargin}{12pt}
        \item การจำลองปรากฏการณ์ฟิสิกส์เสมือนจริงด้วย WebXR, AR และ 3D Spatial Computing
        \item ระเบียบวิธีเชิงตัวเลขและวิทยาการคอมพิวเตอร์ควอนตัม (Quantum Computing \& Simulation)
        \item การพัฒนาระบบ Active Learning และสื่อจำลองเชิงโต้ตอบ 60 FPS บนระบบคลาวด์และเว็บ
