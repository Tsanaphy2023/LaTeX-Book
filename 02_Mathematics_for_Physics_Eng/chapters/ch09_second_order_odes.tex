...
% ==========================================================
% Chapter 9 Instructional Management Plan & Syllabus
% ==========================================================
\section*{Chapter 9 Instructional Management Plan}
\addcontentsline{toc}{section}{Chapter 9 Instructional Management Plan}
...
\begin{enumerate}[topsep=2pt, itemsep=1pt, partopsep=0pt, parsep=0pt, leftmargin=1.5em]
    \item Homogeneous Linear Second-Order ODEs with Constant Coefficients
    \item The Damped Harmonic Oscillator and Three Dynamic Regimes
    \item Driven Oscillations, Resonance, and Quality Factor
    \item Worked Examples: Shock Absorbers and RLC Resonance
...
\begin{enumerate}[topsep=2pt, itemsep=1pt, partopsep=0pt, parsep=0pt, leftmargin=1.5em]
    \item Solve homogeneous second-order linear ODEs via characteristic auxiliary equations.
    \item Analyze and physically classify the three damping regimes: overdamped, critically damped, and underdamped.
    \item Calculate steady-state amplitude, phase lag, and resonance frequency in driven systems.
    \item Quantify resonance sharpness and power dissipation using the Quality factor ($Q$).
\end{enumerate}
\end{planbox}
...
\begin{enumerate}[topsep=2pt, itemsep=1pt, partopsep=0pt, parsep=0pt, leftmargin=1.5em]
    \item Lecture on characteristic equations, complex roots, and phase portrait analysis.
    \item Workshop deriving amplitude resonance curves and power absorption profiles.
    \item Python computational laboratory simulating damped-driven oscillators and phase space spirals.
    \item Historical case study on structural resonance (Tacoma Narrows Bridge collapse).
\end{enumerate}
\end{planbox}

\begin{planbox}[colframe=rbruGold!90!black, colbacktitle=rbruGold!90!black]{4. Instructional Media and Educational Technology}
\begin{enumerate}[topsep=2pt, itemsep=1pt, partopsep=0pt, parsep=0pt, leftmargin=1.5em]
    \item Course textbook: Chapter 9 Second-Order Linear Differential Equations \& Oscillations.
    \item Dynamic resonance curve animations and interactive phase space trajectories.
    \item Python SciPy scripts for numerical integration of nonlinear driven pendulums.
    \item Comprehensive problem sets and worked engineering application examples.
\end{enumerate}
\end{planbox}

\begin{planbox}[colframe=rbruSlate, colbacktitle=rbruSlate]{5. Measurement and Learning Assessment}
\begin{enumerate}[topsep=2pt, itemsep=1pt, partopsep=0pt, parsep=0pt, leftmargin=1.5em]
    \item Formative evaluation of in-class phase space trajectory classifications.
    \item Homework assignment on driven oscillator amplitude response and Quality factor ($Q$).
    \item Chapter 9 summative diagnostic examination on second-order ODEs and resonance.
\end{enumerate}
\end{planbox}
\clearpage
