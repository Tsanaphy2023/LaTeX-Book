...
% ==========================================================
% Chapter 2 Instructional Management Plan & Syllabus
% ==========================================================
\section*{Chapter 2 Instructional Management Plan}
\addcontentsline{toc}{section}{Chapter 2 Instructional Management Plan}
...
\begin{enumerate}[topsep=2pt, itemsep=1pt, partopsep=0pt, parsep=0pt, leftmargin=1.5em]
    \item Vector Algebra and Triple Products
    \item Differential Field Operators: Gradient, Divergence, and Curl
    \item Conservative Vector Fields and Potential Theory
    \item Worked Examples and Electrodynamic Applications
...
\begin{enumerate}[topsep=2pt, itemsep=1pt, partopsep=0pt, parsep=0pt, leftmargin=1.5em]
    \item Perform algebraic operations with dot, cross, and scalar/vector triple products.
    \item Calculate and physically interpret gradient ($\nabla$), divergence ($\nabla \cdot$), and curl ($\nabla \times$).
    \item Construct scalar potentials for conservative fields and verify solenoidal conditions.
    \item Apply vector differential identities to electromagnetic fields and fluid dynamics.
\end{enumerate}
\end{planbox}
...
\begin{enumerate}[topsep=2pt, itemsep=1pt, partopsep=0pt, parsep=0pt, leftmargin=1.5em]
    \item Interactive lecture analyzing spatial gradients, flux divergence, and circulation curl.
    \item Analytical workshops deriving fundamental vector differential identities.
    \item Computational simulation lab visualizing 2D/3D vector fields and streamlines with Python.
    \item Problem-based learning applying potential theory to electrostatic and gravitational fields.
\end{enumerate}
\end{planbox}

\begin{planbox}[colframe=rbruGold!90!black, colbacktitle=rbruGold!90!black]{4. Instructional Media and Educational Technology}
\begin{enumerate}[topsep=2pt, itemsep=1pt, partopsep=0pt, parsep=0pt, leftmargin=1.5em]
    \item Course textbook: Chapter 2 Vector Analysis \& Differential Field Operators.
    \item Multimedia lecture slides featuring field contour maps and curl vortex animations.
    \item Python scripts for vector field quiver plots using Matplotlib and NumPy.
    \item Online problem sets and interactive vector algebra modules.
\end{enumerate}
\end{planbox}

\begin{planbox}[colframe=rbruSlate, colbacktitle=rbruSlate]{5. Measurement and Learning Assessment}
\begin{enumerate}[topsep=2pt, itemsep=1pt, partopsep=0pt, parsep=0pt, leftmargin=1.5em]
    \item Formative assessment through classroom response questions and vector identity proofs.
    \item Evaluation of weekly homework problem sets on field operators and potential theory.
    \item Chapter 2 diagnostic quiz covering analytical calculations and physical field interpretations.
\end{enumerate}
\end{planbox}
\clearpage
