...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{itemize}\setlength{\itemsep}{2pt}\setlength{\parsep}{0pt}\setlength{\topsep}{2pt}\setlength{\partopsep}{0pt}\setlength{\leftmargin}{12pt}
        \item \textbf{Ph.D. (Applied Physics)}\\Doctor of Philosophy in Applied Physics
        \item \textbf{M.Sc. (Applied Physics)}\\Master of Science in Applied Physics
        \item \textbf{B.Sc. (Physics, Computer and Electronics)}\\Bachelor of Science in Physics, Computer and Electronics
    \end{itemize}
