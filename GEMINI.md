...
3. **มาตรฐานเลย์เอาต์ตำรา มรภ.รำไพพรรณี (RBRU Masterclass Layout Standards):**
   ...
   - **การจัดรูปแบบชื่อหัวข้อและการตัดคำ:** ห้ามใส่เครื่องหมายทวิภาค (`:`) ในชื่อหัวข้อ และห้ามใส่วงเล็บภาษาอังกฤษในชื่อหัวข้อหลัก/ย่อย ให้ย้ายคำภาษาอังกฤษไปใส่ในประโยคเปิดของเนื้อหาแทน พร้อมควบคุมการตัดบรรทัดหัวข้อยาวด้วยตนเอง เช่น `\section[ชื่อเต็มในสารบัญ]{บรรทัดที่ 1\\บรรทัดที่ 2}` เพื่อป้องกันคำสำคัญขาดออกจากกัน (เช่น "การ" กับ "หดสั้น")
