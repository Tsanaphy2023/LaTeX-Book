...
\begin{minipage}[t]{0.48\textwidth}
    ...
    \begin{itemize}\setlength{\itemsep}{2pt}\setlength{\parsep}{0pt}\setlength{\topsep}{2pt}\setlength{\partopsep}{0pt}\setlength{\leftmargin}{12pt}
        \item \textbf{ปร.ด. (ฟิสิกส์ประยุกต์)} Ph.D. in Applied Physics\\มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี
        \item \textbf{วท.ม. (ฟิสิกส์ประยุกต์)} M.Sc. in Applied Physics\\มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี
        \item \textbf{วท.บ. (ฟิสิกส์ คอมพิวเตอร์และอิเล็กทรอนิกส์)} B.Sc. in Physics, Computer and Electronics\\มหาวิทยาลัยราชภัฏรำไพพรรณี
    \end{itemize}
