...
\begin{enumerate}
    ...
    \item แปลงตัวแปรในปริพันธ์หลายชั้นโดยใช้จาโคเบียน (Jacobian Determinant) ได้อย่างถูกต้อง
    \item ประยุกต์ใช้ทฤษฎีบทการลู่ออกของเกาส์ (Gauss's Divergence Theorem) ในการคำนวณฟลักซ์และประจุไฟฟ้าได้
    \item ประยุกต์ใช้ทฤษฎีบทของสโตกส์ (Stokes' Theorem) เชื่อมโยงสนามแม่เหล็กไฟฟ้าและการไหลวนในพลศาสตร์ของไหลได้
\end{enumerate}
