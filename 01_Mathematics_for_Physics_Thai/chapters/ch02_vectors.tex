...
\begin{enumerate}
    ...
    \item ประยุกต์ใช้เอกลักษณ์เวกเตอร์เพื่อจัดรูปและแก้สมการทางแม่เหล็กไฟฟ้าและกลศาสตร์ได้
    \item อธิบายหลักการทำงานของเซนเซอร์วัดความเร่งและเข็มทิศดิจิทัลในสมาร์ตโฟน (IMU) และแรงลอเรนซ์ในเครื่องเร่งอนุภาคได้
\end{enumerate}
