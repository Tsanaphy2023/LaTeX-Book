...
\begin{enumerate}[topsep=2pt, itemsep=1pt, partopsep=0pt, parsep=0pt, leftmargin=1.5em]
    \item บทนำและระบบพิกัดคาร์ทีเซียน
    \item ระบบพิกัดทรงกระบอก
    \item ระบบพิกัดทรงกลมและการประยุกต์ในเทคโนโลยี GPS
    \item บทสรุปประจำบท
...
\begin{enumerate}[topsep=2pt, itemsep=1pt, partopsep=0pt, parsep=0pt, leftmargin=1.5em]
    \item อธิบายความหมาย นิยามเรขาคณิต และความสัมพันธ์ระหว่างระบบพิกัดคาร์ทีเซียน พิกัดทรงกระบอก และพิกัดทรงกลมได้อย่างถูกต้อง
    \item คำนวณตัวประกอบสเกล สัมประสิทธิ์เมตริก การกระจัดเชิงอนุพันธ์ พื้นที่ และปริมาตรเชิงอนุพันธ์ในแต่ละระบบพิกัดได้
    \item แปลงเวกเตอร์บอกตำแหน่ง เวกเตอร์ความเร็ว และเวกเตอร์แรงข้ามระบบพิกัดได้อย่างแม่นยำ
    \item ประยุกต์ใช้เรขาคณิตพิกัดทรงกลมในการคำนวณตำแหน่งพิกัดภูมิศาสตร์และระบบกำหนดตำแหน่งบนโลกผ่านดาวเทียมได้
\end{enumerate}
\end{planbox}
...
\begin{enumerate}[topsep=2pt, itemsep=1pt, partopsep=0pt, parsep=0pt, leftmargin=1.5em]
    \item การบรรยายเชิงทฤษฎีประกอบการสาธิตระนาบพิกัดและพื้นผิวสมศักย์แบบ 3 มิติ
    \item กิจกรรมกลุ่มย่อยวิเคราะห์การแปลงระบบพิกัดและคำนวณตัวประกอบสเกล
    \item ปฏิบัติการจำลองการแปลงพิกัดและการพล็อตวิถีอนุภาคด้วย Python
    \item การศึกษาและอภิปรายกรณีศึกษาการระบุตำแหน่งดาวเทียมด้วยพิกัดทรงกลม
\end{enumerate}
\end{planbox}

\begin{planbox}[colframe=rbruGold!90!black, colbacktitle=rbruGold!90!black]{4. สื่อการเรียนการสอน}
\begin{enumerate}[topsep=2pt, itemsep=1pt, partopsep=0pt, parsep=0pt, leftmargin=1.5em]
    \item เอกสารคำสอน บทที่ 1 ระบบพิกัดและการแปลงพิกัด
    \item สไลด์บรรยายอิเล็กทรอนิกส์และแผนภาพเวกเตอร์ 3 มิติ
    \item สคริปต์คำนวณและจำลองเชิงตัวเลขด้วยภาษา Python
    \item แหล่งเรียนรู้ดิจิทัลและระบบการจัดการเรียนรู้ออนไลน์
\end{enumerate}
\end{planbox}
...
\begin{enumerate}[topsep=2pt, itemsep=1pt, partopsep=0pt, parsep=0pt, leftmargin=1.5em]
    ...
    \item การประเมินผลการทำแบบฝึกหัดและการแก้โจทย์ปัญหาท้ายบทที่ 1
