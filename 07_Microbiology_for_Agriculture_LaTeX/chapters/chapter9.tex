...
การวิเคราะห์ไมโครไบโอมของดินในปัจจุบันใช้ 2 แนวทางหลัก:
\begin{enumerate}
    \item \textbf{แอมพลิคอนเมตาบาร์โคดดิง (Amplicon Metabarcoding)} การเพิ่มปริมาณชิ้นส่วนยีนจำเพาะด้วยเทคนิค PCR:
    \begin{itemize}
