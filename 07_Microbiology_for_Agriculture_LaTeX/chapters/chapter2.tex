...
\begin{itemize}
    \item อธิบายขั้นตอนและสมการปฏิกิริยาเคมีในวัฏจักรไนโตรเจน คาร์บอน และฟอสฟอรัสได้
    \item ระบุชนิดของจุลินทรีย์จำเพาะที่ทำหน้าที่ในแต่ละขั้นตอนของวัฏจักรธาตุอาหารได้
    \item วิเคราะห์กลไกการละลายฟอสเฟตด้วยกรดอินทรีย์ของจุลินทรีย์ดินได้
    \item คำนวณปริมาณธาตุอาหารที่ปลดปล่อยจากการย่อยสลายซากพืชในแปลงปลูกได้
\end{itemize}
...
กระบวนการตรึงไนโตรเจนทางชีวภาพเป็นปฏิกิริยารีดักชันที่เปลี่ยนก๊าซ $N_2$ ให้กลายเป็นแอมโมเนีย ($NH_3$) โดยมีตัวเร่งปฏิกิริยาคือเอนไซม์คอมเพล็กซ์ \textbf{ไนโตรจีเนส (Nitrogenase)} ซึ่งประกอบด้วยโปรตีนเหล็ก (Fe protein) และโปรตีนโมลิบดีนัม-เหล็ก (MoFe protein) สมการปฏิกิริยาโดยรวมคือ:
\begin{equation}
...
ไนตริฟิเคชันเป็นกระบวนการออกซิเดชันของแอมโมเนียม ($NH_4^+$) กลายเป็นไนไตรต์ ($NO_2^-$) และตามด้วยไนเตรต ($NO_3^-$) ภายใต้สภาวะที่มีออกซิเจนเพียงพอ ดำเนินการโดยแบคทีเรียคีโมออโตโทรฟ 2 ขั้นตอน:
\begin{enumerate}
    \item \textbf{ขั้นตอนออกซิไดซ์แอมโมเนีย (Ammonia Oxidation)} โดยแบคทีเรีย \textit{Nitrosomonas}:
    \begin{equation}
    2NH_4^+ + 3O_2 \xrightarrow{\text{Nitrosomonas}} 2NO_2^- + 4H^+ + 2H_2O + \text{พลังงาน}
    \end{equation}
    \item \textbf{ขั้นตอนออกซิไดซ์ไนไตรต์ (Nitrite Oxidation)} โดยแบคทีเรีย \textit{Nitrobacter}:
    \begin{equation}
...
เมื่อดินเกิดสภาวะน้ำท่วมขังและขาดออกซิเจน แบคทีเรียกลุ่มไม่ใช้ออกซิเจนแบบเลือกได้ (Facultative Anaerobes) เช่น \textit{Pseudomonas stutzeri} และ \textit{Paracoccus denitrificans} จะใช้ไนเตรตเป็นตัวรับอิเล็กตรอนตัวสุดท้ายในการหายใจ ทำให้ไนเตรตถูกรีดิวซ์กลับเป็นก๊าซไนโตรเจนและก๊าซไนตรัสออกไซด์ ($N_2O$):
\begin{equation}
...
จุลินทรีย์ละลายฟอสเฟต (Phosphate-Solubilizing Microorganisms: PSM) เช่น แบคทีเรีย \textit{Bacillus megaterium}, \textit{Pseudomonas putida} และเชื้อรา \textit{Aspergillus niger} สามารถละลายฟอสเฟตที่ถูกตรึงไว้ได้ผ่าน 2 กลไกสำคัญ:
\begin{enumerate}
