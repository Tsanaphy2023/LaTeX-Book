...
ภาคการเกษตรเป็นทั้งแหล่งปล่อยก๊าซเรือนกระจก (Greenhouse Gas Emissions) ที่สำคัญของโลก และในขณะเดียวกันก็เป็นภาคส่วนที่ได้รับผลกระทบจากความแปรปรวนของสภาพอากาศอย่างรุนแรงที่สุด ก๊าซเรือนกระจกหลัก 2 ชนิดที่เกิดจากกิจกรรมของจุลินทรีย์ในดินเกษตร ได้แก่:
\begin{enumerate}
...
\textbf{ถ่านชีวภาพ (Biochar)} ผลิตจากการเผาวัสดุเหลือทิ้งทางการเกษตร (แกลบ กะลามะพร้าว กากตะกอนอ้อย) ภายใต้สภาวะจำกัดออกซิเจน (Pyrolysis) มีโครงสร้างรูพรุนระดับนาโนและไมโครสูงมาก มีพื้นที่ผิวจำเพาะมากกว่า 200--400 ตารางเมตรต่อกรัม การใส่ถ่านชีวภาพร่วมกับหัวเชื้อจุลินทรีย์ส่งผลดีอย่างยิ่ง:
\begin{itemize}
