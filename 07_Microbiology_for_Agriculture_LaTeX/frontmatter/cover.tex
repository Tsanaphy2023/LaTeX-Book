...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=west, align=left] at ([xshift=1.6in, yshift=2.0in]current page.west) {
        \begin{tcolorbox}[
            ...
            {\fontsize{30}{36}\bfseries\color{white} จุลชีววิทยาการเกษตร}\\[14pt]
            {\color{white}\rule{0.8\textwidth}{1.5pt}}\\[12pt]
            {\fontsize{18}{22}\bfseries\color{agriMint} AGRICULTURAL MICROBIOLOGY}\\[6pt]
    ...
    \node[anchor=south west, align=left] at ([xshift=1.6in, yshift=1.2in]current page.south west) {
        ...
        {\fontsize{12}{15}\color{white!90} วท.บ. (จุลชีววิทยา เกียรตินิยม), วท.ม. (จุลชีววิทยาอุตสาหกรรม), Ph.D. (Microbiology) จุฬาฯ}\\[2pt]
        {\fontsize{12}{15}\color{white!80} สาขาวิชาจุลชีววิทยา คณะวิทยาศาสตร์และเทคโนโลยี มหาวิทยาลัยราชภัฏรำไพพรรณี}\\[8pt]
